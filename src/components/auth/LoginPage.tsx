...
export default function LoginPage() {
  ...
  const { login, register, loginWithGoogle, setCurrentPage } = useStore();
  ...
  const handleDemoLogin = (type: 'user' | 'admin') => {
    if (type === 'user') {
      login('demo@shopverse.com', 'password123');
    } else {
      login('admin@shopverse.com', 'admin123');
    }
    setCurrentPage('home');
  };
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl">
            <p className="text-sm text-amber-800 font-medium mb-3">Quick Demo Access:</p>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full py-3 border border-gray-300 rounded-xl font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
            >
          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="text-white text-center">
              ...
              <p className="text-lg text-white/80">
                Discover amazing deals on thousands of products. Free shipping on orders over $100.
              </p>
